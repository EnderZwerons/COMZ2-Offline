...
public class WrestlerController : EnemyController
{
	...
	private float rush_jump_range = 10f;

	private float rush_jump_range_min = 10f;

	public bool rush_enable = true;

	private float wind_speed_ratio = 5f;
	...
	private float wind_dgm_range = 3f;
	...
	private float bellow_dgm_range = 3f;
